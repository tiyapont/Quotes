                    ...
                    <div class="container">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                      ...
                                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"> <img class="col" src="{{ asset('images/logo.png') }}"></div>
                                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"></div>
                                </div>
                            </div>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-info">
                                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                        ...
                                        <div class ="navbar-nav col-lg-10 col-md-10 col-sm-10 col-xs-10">
